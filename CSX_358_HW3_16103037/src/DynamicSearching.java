...
public class DynamicSearching 
{
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		File file=new File("F:\\java_assignments\\HW3-unsorted-keywords.txt");
		...
		file=new File("F:\\java_assignments\\HW3-input-code.cpp"); // input code
		sc=new Scanner(file);	//file scanned
		
		//Output file "HW3-output-16103037.txt" opened  
		PrintWriter fout=new PrintWriter("F:\\java_assignments\\HW3-OUTPUT-16103037.txt");
